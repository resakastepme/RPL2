    ...
    <div class="container-xxl p-5">
        <div class="row">
            <div class="col-lg">
                ...
                <form action="{{ route('edit.proses.orangtua', $selectDB[0]->id) }}" enctype="multipart/form-data" method="POST" id="form">
                    @csrf

                    <h1> EDIT INFO ORANG TUA </h1>
                    ...
                    <div class="row">
                        <div class="col-sm-10">
                            <a href="/orangtua/admin#mulai" class="btn btn-danger ms-5">
                                << KEMBALI </a>
                        </div>
                        <div class="col-sm-2">
