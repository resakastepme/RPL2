        ...
        <div class="container py-5">
            <div class="row align-items-center">
                <div class="col-lg text-center text-lg-center">
                    <h1 class="display-3 text-white animated zoomIn">KELOLA INFO REMAJA</h1>
    ...
    <div class="container-xxl p-5">
        <div class="row">
            <div class="col-lg">
                ...
                <form action="{{ route('edit.proses.remaja', $selectDB[0]->id) }}" enctype="multipart/form-data" method="POST" id="form">
                    @csrf

                    <h1> EDIT INFO REMAJA </h1>
                    ...
                    <textarea type="text" cols="30" rows="10" class="form-control" name="artikel" id="artikel">{{ $selectDB[0]->artikel }}</textarea>
                    ...
                    <div class="row">
                        <div class="col-sm-10">
                            <a href="/remaja/admin#mulai" class="btn btn-danger ms-5">
                                << KEMBALI </a>
                        </div>
                        <div class="col-sm-2">
