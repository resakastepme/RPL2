    ...
    <div class="container-xxl p-5">
        <div class="row">
            <div class="col-lg">
                ...
                <textarea type="text" cols="30" rows="10" class="form-control" disabled>{{ $selectDB[0]->artikel }}</textarea>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-2">
                        <a href="/remaja/{{ $selectDB[0]->id }}/edit/admin" class="btn btn-warning text-white"> EDIT DATA
                            INI >> </a>
                    </div>
                </div>
