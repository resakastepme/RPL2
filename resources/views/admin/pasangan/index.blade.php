...
@section('content')
    <div class="container-xxl bg-light p-5">
        ...
        <div class="row">
            <div class="col-md-8">
                <a href="{{ url('/tambah/pasangan/admin#mulai') }}">
                ...
                @foreach ($selectDB as $DATA)
                    <tr>
                        ...
                        <td>
                            ...
                            <div class="input-group">
                                <a href="/pasangan/{{ $DATA->id }}/view/admin#mulai"> <button type="button"
                                        class="btn btn-success" name="btnView" id="btnView"> <i class="fa fa-eye"></i>
                                    </button></a>
                                <div class="input-group-append ms-1">
                                    <a href="/pasangan/{{ $DATA->id }}/edit/admin#mulai"><button type="button"
                                            class="btn btn-warning" name="btnEdit" id="btnEdit"> <i class="fa fa-pen"></i>
                                        </button></a>
                                </div>
                                <div class="input-group-append ms-1">
                                    <a href="/pasangan/{{ $DATA->id }}/hapus/proses/admin#mulai" name="btnHapus"
        ...
        $(document).on('click', '#btnHapus', function(e) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href = "/pasangan/" + id + "/hapus/proses/admin#mulai";
                }
            })
