    ...
    <div class="container-xxl p-5">
        <div class="row">
            <div class="col-lg">
                ...
                <form action="{{ route('edit.proses.pasangan', $selectDB[0]->id) }}" enctype="multipart/form-data" method="POST" id="form">
                    @csrf

                    <h1> EDIT INFO PASANGAN </h1>
                    ...
                    <div class="row">
                        <div class="col-sm-10">
                            <a href="/pasangan/admin#mulai" class="btn btn-danger ms-5">
                                << KEMBALI </a>
                        </div>
                        <div class="col-sm-2">
