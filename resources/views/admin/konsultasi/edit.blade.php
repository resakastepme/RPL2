    ...
    <div class="container-xxl p-5">
        <div class="row">
            <div class="col-lg">
                ...
                <form action="{{ route('edit.proses.konsultasi', $selectDB[0]->id) }}" enctype="multipart/form-data" method="POST" id="form">
                    @csrf
                    ...
                    <input type="text" class="form-control" value="{{ $selectDB[0]->gejala }}" name="gejala"
                        id="gejala">
