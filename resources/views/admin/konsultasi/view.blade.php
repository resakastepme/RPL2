    ...
    <div class="container-xxl p-5">
        <div class="row">
            <div class="col-lg">
                ...
                <h4 class="mt-3"> GEJALA </h4>
                <input type="text" class="form-control" value="{{ $selectDB[0]->gejala }}" disabled>
                ...
                <div class="row">
                    <div class="col-sm-10">
                        <a href="/konsultasi/admin#mulai" class="btn btn-danger ms-5">
                            << KEMBALI </a>
                    </div>
                    <div class="col-sm-2">
                        <a href="/konsultasi/{{ $selectDB[0]->id }}/edit/admin#mulai" class="btn btn-warning text-white"> EDIT DATA
                            INI >> </a>
                    </div>
                </div>
